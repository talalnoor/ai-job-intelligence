    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-base">Start analyzing your career fit today</p>
        </div>
        ...
        <p className="text-center text-gray-500 text-base mt-6">
          ...
          <button onClick={onSwitchToLogin} className="text-emerald-400 hover:text-emerald-300 font-semibold">
            Sign in
          </button>
        </p>
      </div>
